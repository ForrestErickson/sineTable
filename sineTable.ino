/*
   A table in ROM of sine and cosine
   Does not work.
*/
//int OFFSET = 128;
// sine and cosine with DC offset of 128.
const static int PROGMEM wave_I[] = {
...
const static int PROGMEM wave_Q[] = {
...
void setup() {
  ...
  Serial.begin(115200);
//  OFFSET = 0;
  Serial.println("Print from a loop");
  ...
  for (i = 0; i < 4; i++)
  {
    Serial.print(i);
    Serial.print(", ");
    Serial.print(String(wave_I[i]));
    Serial.print(", ");
    Serial.print(String(wave_Q[i]));
    Serial.println();
  }
  Serial.println();
  Serial.println(sizeof(wave_I) / sizeof(wave_I[0]));
  Serial.println();
  Serial.println("Print from a hard coded index");
  Serial.print(wave_I[0], DEC);
  Serial.print(", ");
  Serial.println(wave_Q[0]);
  Serial.print(wave_I[1]);
  Serial.print(", ");
  Serial.println(wave_Q[1]);
  Serial.print(wave_I[2]);
  Serial.print(", ");
  Serial.println(wave_Q[2]);
  Serial.print(wave_I[3]);
  Serial.print(", ");
  Serial.println(wave_Q[3]);
}//end setup()
